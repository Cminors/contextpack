...
- Noise@10: 0.870
- Test recall: 0.389
- Median tokens: 7546.5
- Median duration: 3177 ms

## Commits

| Commit | Evaluation query | Hints removed | R@5 | R@10 | MRR | Tokens |
|---|---|---:|---:|---:|---:|---:|
| `24be4040` | accept Standard Schemas in elicit | 2 | 0.33 | 0.33 | 0.50 | 7926 |
| `61866d7a` | runtime-neutral OAuth discovery serving for web-standard hosts | 1 | 0.50 | 0.75 | 0.33 | 7345 |
| `7635115d` | runtime-neutral for web-standard hosts | 2 | 0.00 | 0.00 | 0.08 | 7047 |
| `f172626a` | feat(packaging): ship CommonJS builds alongside ESM for v2 packages | 0 | 0.00 | 0.10 | 0.10 | 7748 |
| `6cc7b1cb` | export toWebRequest(), the IncomingMessage→Request conversion inside | 2 | 0.20 | 0.20 | 0.25 | 8068 |
| `c59dc3aa` | expose icons on /() | 4 | 0.00 | 0.00 | 0.00 | 6866 |
| `78fbe273` | reserved trace context _meta keys and propagation docs(SEP-414) | 1 | 0.25 | 0.25 | 1.00 | 8226 |
| `49c0a711` | deprecate roots, sampling, and logging runtime APIs(SEP-2577) | 0 | 0.33 | 0.33 | 0.33 | 10432 |
| `4a5c863a` | Add consumer-sourced e2e and the legacy SSE matrix column | 1 | 0.11 | 0.11 | 0.50 | 6436 |
| `96db044f` | add isSpecType / specTypeSchemas Records for runtime validation of spec types | 1 | 0.33 | 0.33 | 0.20 | 8402 |
| `db83829c` | custom-method support(3-arg + schema overload) | 3 | 0.13 | 0.13 | 0.33 | 8084 |
| `e15a8ef3` | feat(compat): / accept raw Zod shape, auto-wrap with z object() | 2 | 0.33 | 0.33 | 0.33 | 8254 |
| `7cccc2ac` | restore Resource-Server auth glue(, mcpAuthMetadataRouter) | 2 | 0.50 | 0.67 | 1.00 | 7183 |
| `42cb6b2b` | feat(compat): export from public API surface | 1 | 0.50 | 0.50 | 0.25 | 8264 |
| `9ed62fe7` | support custom claims in | 2 | 1.00 | 1.00 | 1.00 | 7073 |
| `f73a5af4` | Add _meta support to | 1 | 0.50 | 1.00 | 0.25 | 7748 |
| `045c62a1` | remove | 1 | 0.00 | 0.00 | 0.00 | 7324 |
| `6711ed9a` | add reconnectionScheduler to | 2 | 0.67 | 0.67 | 1.00 | 5864 |
| `e563e63b` | introduce minimal AuthProvider interface with adapter | 1 | 0.00 | 0.00 | 0.07 | 5563 |
| `0784be1a` | support Standard for tool/prompt schemas | 1 | 0.13 | 0.13 | 0.50 | 6824 |

## Query Audit

- `24be4040` original: feat(server): accept Standard Schemas in inputRequired.elicit (#2369); removed: `inputRequired`, `server`
- `61866d7a` original: feat(server): runtime-neutral OAuth discovery serving for web-standard hosts (#2422); removed: `server`
- `7635115d` original: feat(server): runtime-neutral requireBearerAuth for web-standard hosts (#2420); removed: `requireBearerAuth`, `server`
- `f172626a` original: feat(packaging): ship CommonJS builds alongside ESM for v2 packages (#2405); removed: none
- `6cc7b1cb` original: feat(node): export toWebRequest(), the IncomingMessage→Request conversion inside toNodeHandler (#2390); removed: `toNodeHandler`, `node`
- `c59dc3aa` original: feat(server): expose icons on registerTool/registerPrompt (McpServer) (#2353); removed: `registerPrompt`, `registerTool`, `McpServer`, `server`
- `78fbe273` original: feat(core): reserved trace context _meta keys and propagation docs (SEP-414) (#2270); removed: `core`
- `49c0a711` original: feat: deprecate roots, sampling, and logging runtime APIs (SEP-2577) (#2268); removed: none
- `4a5c863a` original: Add consumer-sourced e2e requirements and the legacy SSE matrix column (#2203); removed: `requirements`
- `96db044f` original: feat(core): add isSpecType / specTypeSchemas Records for runtime validation of spec types (#1887); removed: `core`
- `db83829c` original: feat(core): custom-method support (3-arg setRequestHandler + request schema overload) (#1974); removed: `setRequestHandler`, `request`, `core`
- `e15a8ef3` original: feat(compat): registerTool/registerPrompt accept raw Zod shape, auto-wrap with z.object() (#1901); removed: `registerPrompt`, `registerTool`
- `7cccc2ac` original: feat(express): restore Resource-Server auth glue (requireBearerAuth, mcpAuthMetadataRouter) (#1907); removed: `requireBearerAuth`, `express`
- `42cb6b2b` original: feat(compat): export InMemoryTransport from public API surface (#1834); removed: `InMemoryTransport`
- `9ed62fe7` original: feat(client): support custom claims in PrivateKeyJwtProvider (#1875); removed: `PrivateKeyJwtProvider`, `client`
- `f73a5af4` original: Add _meta support to registerPrompt (#1629); removed: `registerPrompt`
- `045c62a1` original: feat!: remove WebSocketClientTransport (#1783); removed: `WebSocketClientTransport`
- `6711ed9a` original: feat(client): add reconnectionScheduler to StreamableHTTPClientTransport (#1763); removed: `StreamableHTTPClientTransport`, `client`
- `e563e63b` original: feat: introduce minimal AuthProvider interface with OAuthClientProvider adapter (#1710); removed: `OAuthClientProvider`
- `0784be1a` original: feat: support Standard Schema for tool/prompt schemas (#1689); removed: `schema`
