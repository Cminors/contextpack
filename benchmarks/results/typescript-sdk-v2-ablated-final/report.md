...
- Test recall: 0.139
- Median tokens: 9095
- Median duration: 1533 ms

## Commits

| Commit | Evaluation query | Hints removed | R@5 | R@10 | MRR | Tokens |
|---|---|---:|---:|---:|---:|---:|
| `24be4040` | accept Standard Schemas in elicit | 2 | 0.17 | 0.17 | 0.25 | 9035 |
| `61866d7a` | runtime-neutral OAuth discovery serving for web-standard hosts | 1 | 0.25 | 0.50 | 0.33 | 9155 |
| `7635115d` | runtime-neutral for web-standard hosts | 2 | 0.00 | 0.00 | 0.06 | 8628 |
| `f172626a` | feat(packaging): ship CommonJS builds alongside ESM for v2 packages | 0 | 0.00 | 0.10 | 0.10 | 11584 |
| `6cc7b1cb` | export toWebRequest(), the IncomingMessage→Request conversion inside | 2 | 0.00 | 0.00 | 0.09 | 8844 |
| `c59dc3aa` | expose icons on /() | 4 | 0.00 | 0.00 | 0.00 | 8790 |
| `78fbe273` | reserved trace context _meta keys and propagation docs(SEP-414) | 1 | 0.00 | 0.25 | 0.17 | 12391 |
| `49c0a711` | deprecate roots, sampling, and logging runtime APIs(SEP-2577) | 0 | 0.00 | 0.33 | 0.13 | 8868 |
| `4a5c863a` | Add consumer-sourced e2e and the legacy SSE matrix column | 1 | 0.11 | 0.11 | 0.50 | 10488 |
| `96db044f` | add isSpecType / specTypeSchemas Records for runtime validation of spec types | 1 | 0.00 | 0.33 | 0.10 | 5860 |
| `db83829c` | custom-method support(3-arg + schema overload) | 3 | 0.13 | 0.25 | 0.33 | 7653 |
| `e15a8ef3` | feat(compat): / accept raw Zod shape, auto-wrap with z object() | 2 | 0.33 | 0.33 | 0.33 | 12068 |
| `7cccc2ac` | restore Resource-Server auth glue(, mcpAuthMetadataRouter) | 2 | 0.33 | 0.50 | 0.50 | 7990 |
| `42cb6b2b` | feat(compat): export from public API surface | 1 | 0.50 | 0.50 | 0.25 | 10385 |
| `9ed62fe7` | support custom claims in | 2 | 0.00 | 0.00 | 0.00 | 11844 |
| `f73a5af4` | Add _meta support to | 1 | 0.00 | 0.00 | 0.07 | 10144 |
| `045c62a1` | remove | 1 | 0.00 | 0.00 | 0.00 | 12191 |
| `6711ed9a` | add reconnectionScheduler to | 2 | 1.00 | 1.00 | 1.00 | 9172 |
| `e563e63b` | introduce minimal AuthProvider interface with adapter | 1 | 0.17 | 0.17 | 0.50 | 8942 |
| `0784be1a` | support Standard for tool/prompt schemas | 1 | 0.13 | 0.13 | 0.50 | 7886 |
